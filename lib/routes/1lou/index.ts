...
export const route: Route = {
    ...
    description: `:::tip
  \`1lou.pro/\` 后的内容填入 params 参数，以下是几个例子：

  若订阅 [大陆电视剧](https://www.1lou.pro/forum-2-1.htm?tagids=0_97_0_0)，网址为 \`https://www.1lou.pro/forum-2-1.htm?tagids=0_97_0_0\`。截取 \`https://www.1lou.pro/\` 到末尾 \`.htm\` 的部分 \`forum-2-1\` 作为参数，并补充 \`tagids\`，此时路由为 [\`/1lou/forum-2-1?tagids=0_97_0_0\`](https://rsshub.app/1lou/forum-2-1?tagids=0_97_0_0)。
